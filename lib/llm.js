...
const tools = [
  ...
  },
  {
    ...
    description: 'Load a capability into the Transaction Layer for the user to interact with. For script capabilities, this loads the ExecuteCommand component pre-populated with the command and args.',
    input_schema: {
      type: 'object',
      properties: {
        id: { type: 'string', description: 'Capability ID to load' }
      },
      required: ['id']
    }
  }
...
1. Use create_capability to write and register it
2. Use load_capability to load it in the Transaction Layer
